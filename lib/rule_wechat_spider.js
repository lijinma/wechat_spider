...
module.exports = {
    ...
    getNextPostUrl: function (currentUrl, callback) {
        db.getNextUnupdatedPostContentUrl(currentUrl, callback);
    },
    ...
    replaceServerResDataAsync: function (req, res, serverResData, callback) {
        ...
        if (/mp\/getmasssendmsg/i.test(req.url)) {
            ...
            try {
                var currentUrl = 'http://mp.weixin.qq.com' + req.url;
                this.getNextPostUrl(currentUrl, function (nextUrl) {
                    var next = that.getNextChunk(nextUrl);
                    serverResData = next + serverResData;
                    callback(serverResData);
                });
            }
            ...
            try {
                ...
                console.log('appmsgext', appmsgext);
                ...
                console.log('biz', biz, appmsgid, appmsgext.appmsgstat.read_num);
