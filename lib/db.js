...
var Post = sequelize.define('Post', {
  ...
  isUpdated: {type: Sequelize.INTEGER, defaultValue: 0}, //是否更新过
}, {
  tableName: 'posts'
});
...
var updateOne = function(biz, appmsgid, updateObject) {
    return Post.update(
      updateObject,
      {
        where: {
...
var getNextUnupdatedPostContentUrl = function (biz, appmsgid, title, callback) {
  return Post.update(
      {isUpdated: 1},
      {
        where: {
